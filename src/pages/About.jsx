    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto space-y-8">
        ...
        <p className="text-gray-700 text-center">
          RepairMate was founded with a mission to provide fast, reliable, and professional home repair and appliance services. We aim to make your life easier by bringing skilled technicians directly to your doorstep.
        </p>
